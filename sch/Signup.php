...
<head>
  ...
  <title>Sign Up - Business Record Management System</title>
  <style>
    /* General styles */
body {
  ...
  <div class="container">
    ...
    <div class="form-container sign-in-container">
      <form id="login-form">
        ...
        <p class="message">Don't have an account? <a href="" id="">Sign Up</a></p>
      </form>
    </div>
    <div class="form-container sign-up-container active">
      <form id="signup-form">
        ...
        <p class="message">Already have an account? <a href="login.php" id="">Login</a></p>
      </form>
    </div>
  </div>
